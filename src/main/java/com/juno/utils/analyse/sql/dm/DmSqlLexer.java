...
public class DmSqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "SELECT", "FROM", "ADD", 
			"AS", "ALL", "DISTINCT", "WHERE", "GROUP", "BY", "GROUPING", "SETS", 
			"CUBE", "ROLLUP", "ORDER", "HAVING", "LIMIT", "AT", "OR", "AND", "IN", 
			"NOT", "NO", "IDENTITY", "DEFAULT", "EXISTS", "BETWEEN", "LIKE", "RLIKE", 
	...
	public DmSqlLexer(CharStream input) {
		super(input);
